...
CREATE TABLE play_one_card (
	black_card INTEGER,
	white_card INTEGER,
	play INTEGER,
	win INTEGER,
	FOREIGN KEY ( white_card ) REFERENCES white_cards(id),
	FOREIGN KEY ( black_card ) REFERENCES black_cards(id)
)

ALTER TABLE play_two_card OWNER TO pyx;

CREATE TABLE play_two_card (
	black_card INTEGER,
	white_card1 INTEGER,
	white_card2 INTEGER,
	play INTEGER,
	win INTEGER,
	FOREIGN KEY ( white_card1 ) REFERENCES white_cards(id),
	FOREIGN KEY ( white_card2 ) REFERENCES white_cards(id),
	FOREIGN KEY ( black_card ) REFERENCES black_cards(id)
)

ALTER TABLE play_two_card OWNER TO pyx;

CREATE TABLE play_three_card (
	black_card INTEGER,
	white_card1 INTEGER,
	white_card2 INTEGER,
	white_card3 INTEGER,
	...
	FOREIGN KEY ( white_card1 ) REFERENCES white_cards(id),
	FOREIGN KEY ( white_card2 ) REFERENCES white_cards(id),
	FOREIGN KEY ( white_card3 ) REFERENCES white_cards(id),
	FOREIGN KEY ( black_card ) REFERENCES black_cards(id)
)

ALTER TABLE play_three_card OWNER TO pyx;
--
